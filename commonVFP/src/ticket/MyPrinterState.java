...
public class MyPrinterState {
    ...
    public Font getFont(Font baseFont, int iStyle) {
        ...
        switch (iStyle){
            case 0:
                f = f.deriveFont(baseFont.getStyle());
                break;
            case 1:
                f = f.deriveFont((iStyle & DevicePrinter.STYLE_BOLD) != 0 ? Font.BOLD : baseFont.getStyle());
                break;
            case 2:
                f = f.deriveFont((iStyle & DevicePrinter.STYLE_ITALIC) != 0 ? Font.ITALIC : baseFont.getStyle());
                break;
            case 3:
                f = f.deriveFont((iStyle & DevicePrinter.STYLE_UNDERLINE) != 0 ? Font.HANGING_BASELINE : baseFont.getStyle());
                break;
